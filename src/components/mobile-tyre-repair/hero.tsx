...
import { HERO } from "@/lib/mobile-tyre-repair-content";

const CRUMBS = [
  { name: "Home", path: "/" },
  { name: "Services", path: "/services" },
  { name: "Mobile Tyre Repair", path: "/services/mobile-tyre-repair" },
];

/**
 * Section 1 - Hero. Cloned from the mobile-tyre-fitting hero: 60/40 split on
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:py-16 lg:grid-cols-5 lg:gap-12">
        ...
        <div className="lg:col-span-3">
          ...
          <h1 className="mt-4 font-heading text-3xl font-extrabold tracking-tight sm:text-5xl">
            Mobile Puncture Repair Near Me, At Home, Work or Roadside
          </h1>
        ...
        <div className="lg:col-span-2">
          ...
          >
            <h2 className="px-5 pt-5 font-heading text-xl font-bold text-primary">
              Book Mobile Puncture Repair
            </h2>
            <div className="p-1">
              <BookingForm phone={phone} defaultService="Mobile Puncture Repair" />
            </div>
          </div>
        </div>
      </div>

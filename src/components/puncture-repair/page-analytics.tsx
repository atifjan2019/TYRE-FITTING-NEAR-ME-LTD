...
/**
 * Conversion tracking for the puncture repair page. Pushes GA4-style events to
 * window.dataLayer (works with GTM and gtag's dataLayer). Uses event delegation
 * so it captures clicks inside reused components (CtaBand, FAQ accordion) without
 * forking them.
 *
 * Events: form_view, form_start, cta_click_phone, cta_click_whatsapp, faq_open,

...
import { HERO } from "@/lib/tpms-service-content";

const CRUMBS = [
  { name: "Home", path: "/" },
  { name: "Services", path: "/services" },
  { name: "TPMS Service", path: "/services/tpms-service" },
];
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:py-16 lg:grid-cols-5 lg:gap-12">
        ...
        <div className="lg:col-span-3">
          ...
          <h1 className="mt-4 font-heading text-3xl font-extrabold tracking-tight sm:text-5xl">
            TPMS Service Near Me, Valve Service, Sensor Replacement and Reset
          </h1>
        ...
        <div className="lg:col-span-2">
          ...
          >
            ...
            <div className="p-1">
              <BookingForm
                phone={phone}
                defaultService="TPMS Service"
                messagePlaceholder="TPMS warning light on? Steady or flashing? Your MOT date if you have one booked."
              />
            </div>
          </div>
        </div>

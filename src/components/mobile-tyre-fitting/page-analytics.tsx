...
/**
 * Conversion tracking for the mobile tyre fitting page. Pushes GA4-style events
 * to window.dataLayer (works with GTM and gtag's dataLayer). Uses event
 ...
 *
 * Note: form_submit_success is not fired here because the shared BookingForm
 * owns its own submit lifecycle. Wire it from BookingForm's success branch (or
 * a thank-you route) when you want that event.
 */
...
export function PageAnalytics() {
  useEffect(() => {
    // --- Delegated clicks: phone / WhatsApp CTAs and FAQ opens ---------------
    ...
    // --- form_start: first focus into a field within the booking form -------
    ...
    // --- Scroll depth: 50% and 90% (fire once each) -------------------------
    ...
    // --- form_view: booking form enters the viewport (once) -----------------

...
/**
 * Conversion tracking for the emergency tyre fitting page. Pushes GA4-style
 * events to window.dataLayer (works with GTM and gtag's dataLayer). Uses event
 * delegation so it captures clicks inside reused components (CTA bands, sticky
 * call bar, FAQ accordion) without forking them.
 *

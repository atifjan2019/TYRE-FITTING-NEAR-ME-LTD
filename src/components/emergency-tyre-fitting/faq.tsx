...
/**
 * Emergency-tyre-fitting FAQ accordion. Native <details>/<summary>: every answer
 ...
 * the phrase "mobile tyre repair" turned into a contextual link to the sibling
 * repair page. Visible text stays byte-identical to the `answer` string that

...
/**
 * Conversion tracking for the run-flat tyre page. Pushes GA4-style events to
 * window.dataLayer (works with GTM and gtag's dataLayer). Uses event delegation
 * so it captures clicks inside reused components (CtaBand, FAQ accordion)

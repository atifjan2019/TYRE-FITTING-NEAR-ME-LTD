...
import { VanButtons } from "@/components/van-tyre-fitting/cta";
import { HERO } from "@/lib/van-tyre-fitting-content";

const CRUMBS = [
  { name: "Home", path: "/" },
  { name: "Services", path: "/services" },
  { name: "Van Tyre Fitting", path: "/services/van-tyre-fitting" },
];
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:py-16 lg:grid-cols-5 lg:gap-12">
        ...
        <div className="lg:col-span-3">
          ...
          <h1 className="mt-4 font-heading text-3xl font-extrabold tracking-tight sm:text-5xl">
            Van Tyre Fitting Near Me, At Your Depot, Site or Driveway
          </h1>
          ...
          <VanButtons className="mt-8" />

          <p className="mt-4 text-sm text-primary-foreground/70">
            Book with a postcode and registration, or call for urgent and fleet enquiries.
          </p>
        </div>
        ...
        <div className="lg:col-span-2">
          ...
          >
            <h2 className="px-5 pt-5 font-heading text-xl font-bold text-primary">
              Book Van Tyre Fitting
            </h2>
            <div className="p-1">
              <BookingForm
                phone={phone}
                defaultService="Van Tyre Fitting"
                messagePlaceholder="Number of vans, tyre sizes if known, depot or site postcode, best time to fit…"
              />
            </div>
          </div>
        </div>

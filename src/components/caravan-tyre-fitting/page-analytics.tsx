...
/**
 * Conversion tracking for the caravan and motorhome tyre fitting page. Pushes
 * GA4-style events to window.dataLayer (works with GTM and gtag's dataLayer).
 * Uses event delegation so it captures clicks inside reused components (CTA
 * bands, FAQ accordion) without forking them.
 *

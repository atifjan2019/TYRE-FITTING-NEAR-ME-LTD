...
import {
  ...
  AREAS,
  CASE_STUDY,
} from "@/lib/caravan-tyre-fitting-content";
...
/* ===========================================================================
   Section 2 - Your caravan is not on your driveway (prose, positioning wedge)
   =========================================================================== */
...
/* ===========================================================================
   Section 2b - Where we fit (location card row near the top)
   =========================================================================== */
  ...
  return (
    <section className="section-pad bg-secondary">
      <div className="mx-auto max-w-7xl px-4">
        <SectionHeading
          eyebrow="On-site fitting"
          title="Where We Fit Your Caravan and Motorhome Tyres"
        />
        <ul className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 lg:grid-cols-7">
          {WHERE_WE_FIT.map((loc) => (
            <li
              key={loc.label}
              className="surface-card flex flex-col items-center gap-2 p-4 text-center"
            >
              <span className="grid h-11 w-11 place-items-center rounded-xl bg-accent text-accent-foreground">
                <Icon name={loc.icon} className="h-5 w-5" />
              </span>
...
/* ===========================================================================
   ...
   Two-column Replace by Age (green) vs Tread Alone Is Not Enough (red).
   Crawlable HTML, carrying class "tyre-age-explainer" for the WebPage speakable
   schema.
   =========================================================================== */
export function TyreAge() {
  return (
    <section className="section-pad bg-background">
      <div className="mx-auto max-w-7xl px-4">
        <SectionHeading
          eyebrow="Age vs tread"
          title="Why Caravan Tyres Age Before They Wear Out"
          subtitle={AGE_INTRO}
        />

        <ComparisonBlock
          className="tyre-age-explainer mt-10"
          left={{ title: "Replace by Age", items: AGE_YES }}
          right={{ title: "Tread Alone Is Not Enough", items: AGE_NO }}
          rightMode="cross"
          caption={AGE_CLOSE}
        />
      </div>
...
/* ===========================================================================
   Section 4 - CP-rated and load-rated tyres (three tiles, speakable)
   Wrapper carries class "cp-rated-explainer" so the speakable selector encloses
   all of the technical-fitment text.
   =========================================================================== */
export function CpRated() {
  return (
    <section className="section-pad bg-secondary">
      <div className="mx-auto max-w-7xl px-4">
        <SectionHeading
          eyebrow="Load ratings explained"
          title="CP-Rated Motorhome Tyres and Correct Load Ratings"
          subtitle={CP_INTRO}
        />

        <div className="cp-rated-explainer mt-10 grid gap-4 sm:gap-6 lg:grid-cols-3">
          {CP_TILES.map((t) => (
            <div key={t.title} className="surface-card flex h-full flex-col p-5 sm:p-7">
              <span className="inline-block w-fit rounded-full bg-accent/10 px-3 py-1 text-xs font-bold uppercase tracking-wide text-accent">
                {t.tag}
              </span>
              <h3 className="mt-3 font-heading text-xl font-bold text-primary">{t.title}</h3>
        ...
        <p className="callout mx-auto mt-8 max-w-3xl leading-relaxed text-muted-foreground">
          {CP_CLOSE} A motorhome with a tyre pressure warning is handled through our{" "}
...
/* ===========================================================================
   Section 5 - What you get (trust tile grid) + emergency-page link
   =========================================================================== */
    ...
    <section className="section-pad bg-primary text-primary-foreground">
      <div className="mx-auto max-w-7xl px-4">
        <h2 className="text-center font-heading text-3xl font-extrabold leading-[1.2] tracking-tight sm:text-4xl">
          What You Get with Mobile Caravan Tyre Fitting
        </h2>
        ...
        <p className="mx-auto mt-10 max-w-3xl text-center leading-relaxed text-primary-foreground/90">
          A blowout while towing reaches the same fitter through our{" "}
          <Link href="/services/emergency-tyre-fitting" className="font-semibold text-accent hover:underline">
            emergency tyre fitting
          </Link>{" "}
          service, with a 30 to 60 minute typical response, 24 hours a day.
        </p>
      </div>
    </section>
  );
...
/* ===========================================================================
   Section 6 - How caravan and motorhome tyre fitting works (drives HowTo schema)
   =========================================================================== */
export function Process() {
  return (
    <section className="section-pad bg-background">
      <div className="mx-auto max-w-7xl px-4">
        <SectionHeading eyebrow="Step by step" title="How Mobile Caravan and Motorhome Tyre Fitting Works" />
...
/* ===========================================================================
   Section 7 - Tyron safety bands removed and refitted (differentiator)
   =========================================================================== */
export function Tyron() {
  return (
    <section className="section-pad bg-secondary">
      <div className="mx-auto max-w-7xl px-4">
        <div className="overflow-hidden rounded-3xl bg-primary p-8 text-primary-foreground shadow-lg sm:p-12">
          ...
          <div className="mt-4 max-w-3xl space-y-4 text-lg text-primary-foreground/90">
            {TYRON.paras.map((p) => (
              <p key={p.slice(0, 24)}>{p}</p>
            ))}
          </div>
          <p className="mt-6 flex items-start gap-2.5 rounded-xl border border-white/10 bg-white/5 p-4 text-sm">
            <Check className="mt-0.5 h-4 w-4 shrink-0 text-[var(--color-whatsapp)]" aria-hidden="true" />
            <span>{TYRON.note}</span>
          </p>
        </div>
      </div>
    </section>
...
/* ===========================================================================
   Section 8 - Leisure vehicles covered (tag grid) + van page pointer
   =========================================================================== */
export function VehiclesCovered() {
  return (
    <section className="section-pad bg-background">
      <div className="mx-auto max-w-7xl px-4">
        <SectionHeading title="Leisure Vehicles Covered" />
        ...
        <p className="mx-auto mt-8 max-w-3xl text-center leading-relaxed text-muted-foreground">
          Single-axle and twin-axle caravans are both covered, with CP-rated, reinforced and load-rated
          leisure tyres matched to each vehicle and its laden weight. Campervans on a van base are covered
          too, and van-based motorhomes are served from the{" "}
          <Link href="/services/van-tyre-fitting" className="font-medium text-accent hover:underline">
            van tyre fitting
          </Link>{" "}
          page.
        </p>
...
export function Costs() {
  return (
    <section className="section-pad bg-secondary">
      <div className="mx-auto max-w-7xl px-4">
        <SectionHeading title="Caravan and Motorhome Tyre Fitting Cost" />
        <p className="pricing-summary mt-6 text-center font-heading text-2xl font-extrabold text-primary sm:text-3xl">
          ...
          <span className="mt-1 block text-lg font-bold text-accent">
            Caravan or motorhome tyre priced by size and type, quoted before booking
          </span>
        </p>
...
/* ===========================================================================
   Section 10 - Emergency and roadside (bridge, links to emergency + repair)
   =========================================================================== */
  ...
  return (
    <section className="section-pad bg-background">
      <div className="mx-auto max-w-3xl px-4">
        ...
        <div className="mt-6 space-y-5 text-lg leading-relaxed text-foreground/80">
          <p>
            A blowout while towing a caravan is an emergency, so roadside replacement is available 24 hours
            a day, 365 days a year, with a 30 to 60 minute typical response through our{" "}
            <Link href="/services/emergency-tyre-fitting" className="font-semibold text-accent hover:underline">
              emergency tyre fitting
            </Link>{" "}
            service.
          ...
          <p>
            A repairable caravan puncture is handled where it passes assessment through{" "}
            <Link href="/services/mobile-tyre-repair" className="font-semibold text-accent hover:underline">
              mobile tyre repair
            </Link>
            , and a torn or aged sidewall is replaced rather than patched. Roadside work on a live road
            follows National Highways protocol, with the technician positioned safely before the wheel comes
            off.
          </p>
        </div>
      </div>
...
/* ===========================================================================
   Section 11 - Why leisure owners choose us (stat tiles).
...
export function WhyChoose() {
  return (
    <section className="section-pad bg-secondary">
      <div className="mx-auto max-w-7xl px-4">
        <SectionHeading title="Why Leisure Owners Choose Tyre Fitting Near Me Ltd" />
        <p className="mx-auto mt-4 max-w-3xl text-center text-lg text-muted-foreground">
          Tyre Fitting Near Me Ltd comes to the storage compound, campsite or pitch, where national chains
          list caravan tyres as a drive-in catalogue category with no age check at all.
        </p>
        ...
        <p className="mt-8 text-center font-medium text-primary">
          On-site fitting kills the towing risk a garage visit creates, backed by a 12-month workmanship
          guarantee.
        </p>
      </div>
    </section>
...
export function AreasCoverage() {
  return (
    <section className="section-pad bg-secondary">
      <div className="mx-auto max-w-7xl px-4">
        <SectionHeading
          title="Caravan and Motorhome Tyre Fitting Coverage Across the UK"
          subtitle={AREAS_INTRO}
        />
        <div className="mt-10 grid gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
          {AREAS.map((area) => (
      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="surface-card p-5 sm:p-8">
          ...
          <h2 className="mt-4 font-heading text-2xl font-extrabold tracking-tight text-primary sm:text-3xl">
            Caravan Tyre Fitting in Action
          </h2>
